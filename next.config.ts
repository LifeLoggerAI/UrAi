...
const cspHeader = `
    ...
    connect-src 'self' wss://*.googleapis.com https://*.googleapis.com https://accounts.google.com https://*.google.com https://*.cloudworkstations.dev http://127.0.0.1:9099 ws://127.0.0.1:8080;
