...
const cspHeader = `
    ...
    connect-src 'self' https://*.googleapis.com https://accounts.google.com https://*.cloudworkstations.dev wss://*.cloudworkstations.dev http://127.0.0.1:9099 http://127.0.0.1:8080 ws://127.0.0.1:8080;
