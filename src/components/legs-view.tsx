  ...
  const panels = [
    {
      ...
      content: (
        <p className='text-center text-muted-foreground mt-8'>Movement History map coming soon.</p>
      ),
    },
    {
      ...
      content: (
        <p className='text-center text-muted-foreground mt-8'>Trajectory forecast coming soon.</p>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <p className='text-center text-muted-foreground mt-8'>Momentum Score coming soon.</p>
      ),
    },
  ];
