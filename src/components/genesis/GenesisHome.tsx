...
export default function GenesisHome({ entryState: _entryState }: { entryState?: WorldEntryState }) {
...
const styles = `
  ...
  .companion-dot{position:absolute;right:9%;bottom:12%;width:48px;height:48px;border:1px solid rgba(255,255,252,.24);border-radius:999px;background:rgba(255,255,255,.08);backdrop-filter:blur(18px)}.companion-dot span{display:block;margin:auto;width:14px;height:14px;border-radius:999px;background:var(--aura);box-shadow:0 0 18px var(--aura)}
