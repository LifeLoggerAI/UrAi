  ...
  if (people.length === 0) {
    return (
      <div className="text-center text-muted-foreground py-16 px-4 bg-card border rounded-lg animate-fadeIn">
        ...
        <h3 className="mt-4 text-lg font-medium text-foreground">Your Social Constellation is Forming</h3>
        <p className="mt-1 text-sm">Mention someone in a voice note, and they will appear here.</p>
      </div>
    )
  }
  return (
