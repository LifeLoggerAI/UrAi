...
export function HumanGLBPresence({
  ...
  return (
    <group
      ...
      userData={{ representation: "generated-glb-human-v1", replaceableByScanGradeHuman: true, nominalHeightMeters: 1.82 }}
    >
...
Object.values(URAI_REAL_3D).forEach((src) => useGLTF.preload(src));
