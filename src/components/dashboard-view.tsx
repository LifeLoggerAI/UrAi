    ...
    return (
      <div className='text-center text-muted-foreground py-16 px-4 bg-card border rounded-lg animate-fadeIn'>
        ...
        <p className='mt-1 text-sm'>
          Log some voice notes, dreams, or reflections to see your Cognitive Mirror come to life.
        </p>
      </div>
    );
  }
    ...
    <div className='space-y-6 animate-fadeIn'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your emotional valence over the last 30 days. (1 = very positive, -1 = very negative)
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The most frequent emotions detected in your entries over the last 30 days.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ChartContainer config={chartConfig} className='h-64 w-full'>
