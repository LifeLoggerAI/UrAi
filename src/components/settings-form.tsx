                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="warmCalm">
                          Warm &amp; Calm
                        </SelectItem>
                        <SelectItem value="neutralAnalytical">
                          Neutral &amp; Analytical
                        </SelectItem>
                        <SelectItem value="poeticSoft">
                          Poetic &amp; Soft
                        </SelectItem>
                      </SelectContent>
                    </Select>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Allow GPS access to track movement and location
                        patterns.
                      </FormDescription>
                    </div>
                    <FormControl>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="outline">
                <FileDown className="mr-2" /> Export My Data
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will start the process of exporting all your data. You
                  will receive an email with a secure download link when it's
                  ready. This may take some time.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="destructive">
                <Trash2 className="mr-2" /> Erase My Logs
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
