...
const fromStarBase = <T extends string>(base: MemoryStar, overrideType: T): Omit<MemoryStar, "type"> & { type: T } => ({
  ...base,
  type: overrideType,
});
...
const constellationSeeds: Array<Pick<LifeConstellation, "id" | "theme" | "starIds" | "lineColor">> = [
