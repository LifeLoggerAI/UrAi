...
const fromStarBase = <T extends string>(
  base: MemoryStar,
  overrideType: T,
): Omit<MemoryStar, "type"> & { type: T } => ({
  ...base,
  type: overrideType,
});
...
export const memoryStars: MemoryStar[] = [
  ...
  star(
    ...
    "recovery",
    "Soft Return",
    "first green-gold recovery thread",
    -1.4,
    0.2,
    -0.4,
    ["recovery", "relief"],
...
export const relationshipBodies: RelationshipBody[] = [
  "Friend Orbit",
  "Family Moon",
  "Creative Partner",
  "Past Echo",
...
const constellationSeeds: Array<
  Pick<LifeConstellation, "id" | "theme" | "starIds" | "lineColor">
> = [
  {
    id: "grief-thread",
    theme: "Grief",
    starIds: ["blue-fog-memory", "winter-thread", "soft-return"],
    lineColor: "#bfe9ff",
  },
  {
    id: "recovery-thread",
    theme: "Recovery",
    starIds: ["quiet-ritual", "soft-return", "blue-fog-memory"],
    lineColor: "#86efac",
  },
  {
    id: "relationship-thread",
    theme: "Relationships",
    starIds: ["orbit-close", "companion-watch"],
    lineColor: "#f9a8d4",
  },
  {
    id: "dream-thread",
    theme: "Dream Field",
    starIds: ["dream-orchid", "mirror-self"],
    lineColor: "#c084fc",
  },
  {
    id: "mirror-thread",
    theme: "Mirror",
    starIds: ["mirror-self", "purpose-north"],
    lineColor: "#f8fafc",
  },
  {
    id: "shadow-thread",
    theme: "Shadow",
    starIds: ["shadow-loop", "work-flare", "threshold-door"],
    lineColor: "#64748b",
  },
  {
    id: "legacy-thread",
    theme: "Legacy",
    starIds: ["legacy-gold", "purpose-north"],
    lineColor: "#facc15",
  },
  {
    id: "rebirth-thread",
    theme: "Rebirth",
    starIds: ["threshold-door", "rebirth-bloom", "joy-spark"],
    lineColor: "#fb7185",
  },
];
...
const nebulaRegions: NebulaRegion[] = [
  "Grief Fog",
  "Stress Shimmer",
  "Dream Cloud",
  "Mirror Field",
...
const replaySequences: ReplaySequence[] = [
  {
    ...fromStarBase(
      star(
        ...
        "memory",
        "Blue Thread Replay",
        "camera path through grief and recovery",
        0,
        0,
        0,
        ["replay"],
