...
import { getFirestore, connectFirestoreEmulator, type Firestore, enableNetwork } from "firebase/firestore";
...
if (devMode) {
  ...
  try {
    ...
    enableNetwork(db);
    console.log("✅ Firebase emulators connected and network enabled.");
  } catch (e) {
