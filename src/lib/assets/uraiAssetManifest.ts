...
export const URAI_ASSET_MANIFEST: Record<UraiAssetKey, UraiAssetManifestEntry> = {
  skyBackground: { key: "skyBackground", path: "/assets/sky/bloom/fallback-sky-bloom-12.webp", layerType: "sky", fallback: "dark_sky", preferredFormat: "png", expectedRatio: "vertical", expectedDimensions: "1440x3120", critical: true, lazy: false },
  ...
  bodySilhouetteBase: { key: "bodySilhouetteBase", path: TRANSPARENT_PIXEL, layerType: "body", fallback: "transparent", preferredFormat: "png", expectedRatio: "vertical", expectedDimensions: "1440x3120", critical: true, lazy: false },
  bodySilhouetteGlow: { key: "bodySilhouetteGlow", path: TRANSPARENT_PIXEL, layerType: "body", fallback: "transparent", preferredFormat: "png", expectedRatio: "vertical", expectedDimensions: "1440x3120", critical: true, lazy: false },
  ...
  auraField: { key: "auraField", path: TRANSPARENT_PIXEL, layerType: "body", fallback: "transparent", preferredFormat: "png", expectedRatio: "vertical", expectedDimensions: "1440x3120", critical: true, lazy: false },
  ...
  orbCore: { key: "orbCore", path: "/assets/images/genesis-orb-placeholder.svg", layerType: "orb", fallback: "transparent", preferredFormat: "png", expectedRatio: "square", expectedDimensions: "1024x1024", critical: true, lazy: false },
  orbGlow: { key: "orbGlow", path: TRANSPARENT_PIXEL, layerType: "orb", fallback: "transparent", preferredFormat: "png", expectedRatio: "square", expectedDimensions: "1024x1024", critical: true, lazy: false },
  ...
  groundBase: { key: "groundBase", path: "/assets/ground/bloom/fallback-ground-bloom-12.png", layerType: "ground", fallback: "transparent", preferredFormat: "png", expectedRatio: "wide", expectedDimensions: "1440x900", critical: true, lazy: false },
  ...
  foregroundVignette: { key: "foregroundVignette", path: TRANSPARENT_PIXEL, layerType: "vignette", fallback: "transparent", preferredFormat: "png", expectedRatio: "vertical", expectedDimensions: "1440x3120", critical: true, lazy: false },
