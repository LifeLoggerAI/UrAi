...
export const URAI_SOUND_REGISTRY: Record<UraiSoundId, UraiSoundDefinition> = {
  genesis_ambient: {
    ...
    category: "ambient",
    src: "/assets/audio/genesis-ambient-placeholder.wav",
    defaultVolume: 0.2,
    loop: true,
  ...
  orb_open: {
    ...
    label: "Orb Open",
    category: "ui",
    src: "/assets/audio/orb-open-placeholder.wav",
    defaultVolume: 0.4,
    userGestureRequired: true,
  },
  orb_close: {
    ...
    label: "Orb Close",
    category: "ui",
    src: "/assets/audio/orb-close-placeholder.wav",
    defaultVolume: 0.4,
    userGestureRequired: true,
  },
  companion_open: {
    ...
    category: "companion",
    src: "/assets/audio/companion-open-placeholder.wav",
    defaultVolume: 0.5,
    userGestureRequired: true,
  },
  companion_message: {
    ...
    category: "companion",
    src: "/assets/audio/companion-message-placeholder.wav",
    defaultVolume: 0.6,
  ...
  passport_open: {
    ...
    label: "Passport Open",
    category: "ui",
    src: "/assets/audio/system-soft-placeholder.wav",
    defaultVolume: 0.4,
    userGestureRequired: true,
  },
  lifemap_star: {
