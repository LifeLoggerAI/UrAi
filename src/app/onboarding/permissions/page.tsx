...
const permissionItems = [
  {
    ...
    description:
      'Can I quietly listen to the world around you? I’ll never record words unless you ask.',
  },
  {
  ...
  },
  {
    ...
    description:
      'How you move tells a story. May I watch gently to detect steps, movement, and periods of rest?',
  },
  {
    ...
    title: 'Notifications',
    description:
      'I’ll only speak softly when something meaningful arises. This includes ritual reminders and gentle nudges.',
  },
  {
    ...
    description:
      'Would you like to let your growth guide others? I’ll share only patterns — never identity.',
  },
];
          ...
          <>
            <CardHeader>
              <CardTitle className='flex items-center gap-3 font-headline text-2xl'>
                <ShieldQuestion /> Your Story, Your Rules
              </CardTitle>
              <CardDescription>
                To reflect your world, I need to perceive it. Please grant permissions for the
                experiences you want to enable.
              </CardDescription>
            </CardHeader>
        ...
        {step === 'consent' && (
          <>
            <CardHeader>
              ...
              <CardDescription>
                One last step to confirm your ownership and control.
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <ScrollArea className='h-64 w-full rounded-md border p-4 text-sm'>
                ...
                <p className='mt-2 text-muted-foreground'>
                  Welcome to Life Logger. Before we begin, we honor your right to:
                </p>
                ...
                <p className='mt-4 font-semibold text-foreground'>
                  We never sell your identity or raw data. Only anonymized, aggregated patterns may
                  be used to help others — if you explicitly opt-in.
                </p>
                <p className='mt-2 text-muted-foreground'>
