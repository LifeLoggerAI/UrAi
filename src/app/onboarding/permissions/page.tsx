...
const permissionItems = [
  ...
  },
  {
    ...
    title: 'Location (GPS)',
    description:
      'Knowing your place in space helps me find meaning in movement and routines.',
  },
  {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Now for the final step.',
      });
        ...
        {step === 'permissions' && (
          <>
            <CardHeader>
              ...
              <CardDescription>
                To reflect your world, I need to perceive it. Please grant
                permissions for the experiences you want to enable.
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex items-center space-x-2 pt-2">
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    setAcceptedConsent(Boolean(checked))
                  }
                />
                <label
                  htmlFor="terms"
