  ...
  const requestMicPermission = async () => {
    ...
    try {
        ...
        reader.onloadend = async () => {
          ...
          try {
            ...
            toast({
              ...
              description: 'Could not save your onboarding data. Please try again.',
            });
      ...
      toast({
        ...
        description: 'Please enable microphone access in your browser settings to continue.',
      });
      setPermissionState('denied');
    }
  };
      ...
      <main className='flex min-h-screen flex-col items-center justify-center bg-background p-4 sm:p-8'>
        <Card className='w-full max-w-lg animate-fadeIn text-center'>
          <CardHeader>
            ...
            <CardDescription>
              To capture your voice, Life Logger needs access to your microphone. Your recordings
    ...
    <main className='flex min-h-screen flex-col items-center justify-center bg-background p-4 sm:p-8'>
      <Card className='w-full max-w-2xl animate-fadeIn text-center'>
        <CardHeader>
          ...
          <CardDescription>
            Let&apos;s begin by seeding your inner voice. I&apos;ll ask a few questions. Please
            respond in one continuous recording.
          </CardDescription>
        </CardHeader>
          ...
          <div className='h-10'>
            {recordingState === 'processing' && (
              <p className='text-sm text-muted-foreground flex items-center gap-2'>
                <Loader2 className='animate-spin' /> Analyzing your reflection...
              </p>
            )}
            {recordingState === 'done' && (
