...
export const metadata = {
  title: "Dashboard not live in V1 | URAI",
  description: "URAI dashboard access is not live in V1 until private account, privacy, and audit evidence is complete.",
};
  ...
  return (
    <main className="min-h-screen bg-[#030712] px-6 py-12 text-white">
      <section className="mx-auto flex min-h-[80vh] max-w-4xl flex-col justify-center">
        <p className="text-xs font-semibold uppercase tracking-[0.35em] text-amber-200/75">Not live in V1</p>
        <h1 className="mt-4 text-4xl font-semibold tracking-[-0.04em] sm:text-6xl">Dashboard access is not live in V1.</h1>
        <p className="mt-5 max-w-2xl text-base leading-7 text-white/68">
          The URAI dashboard is not live in V1 and will require private account, consent, export/delete, retention, and audit evidence before it becomes a live user surface. For launch, use the public demo and waitlist only.
        </p>
