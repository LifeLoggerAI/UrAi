...
exports.updateShadowMetrics = void 0;
...
exports.updateShadowMetrics = (0, firestore_1.onDocumentWritten)('voiceEvents/{id}', function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var data, userId, userRef, metricsDoc, current, entropyScore;
    var _a, _b;
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!data)
                    return [2 /*return*/];
                userId = data.userId;
                userRef = db.collection('shadowMetrics').doc(userId);
                return [4 /*yield*/, userRef.get()];
            case 1:
                metricsDoc = _c.sent();
                current = metricsDoc.exists ? metricsDoc.data() : {
                    frictionTaps: 0,
                ...
                entropyScore = Math.min((current.cancelBehaviorCount * 0.1) +
                    (current.frictionTaps * 0.05) +
                    (current.bedtimeScrollMinutes * 0.02), 1);
                return [4 /*yield*/, userRef.set(__assign(__assign({}, current), { entropyLevel: entropyScore, lastUpdated: new Date().toISOString() }), { merge: true })];
            case 2:
                _c.sent();
                return [2 /*return*/];
        }
